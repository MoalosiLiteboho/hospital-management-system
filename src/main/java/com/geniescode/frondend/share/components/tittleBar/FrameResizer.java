package com.geniescode.frondend.share.components.tittleBar;
...
public class FrameResizer extends MouseAdapter {
    ...
    public FrameResizer(Component... components) {
        this(new Insets(5, 5, 5, 5), new Dimension(1, 1), components);
    }

    public FrameResizer(Insets dragInsets, Component... components) {
        this(dragInsets, new Dimension(1, 1), components);
    }

    public FrameResizer(Insets dragInsets, Dimension snapSize, Component... components) {
