...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdForward.setIcon(new GoogleMaterialIcon(GoogleMaterialDesignIcon.FORWARD, null, Color.white, Color.white, 20).toIcon()); // NOI18N
        ...
        cmdPrevious.setIcon(new GoogleMaterialIcon(GoogleMaterialDesignIcon.ARROW_BACK, null, Color.white, Color.white, 20).toIcon()); // NOI18N
